...
class PcHoverCardSettings(BaseModel):
    fields: list[str] = Field(default_factory=list, max_length=14)


class FloorLayoutSettings(BaseModel):
    pc_hover_card: PcHoverCardSettings | None = None
...
class FloorLayoutPayload(BaseModel):
    ...
    settings: FloorLayoutSettings | None = None
