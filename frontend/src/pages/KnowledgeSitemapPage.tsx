...
const DEFAULT_PC_HOVER_FIELDS: PcHoverCardField[] = ['title', 'outlets', 'ip', 'os', 'ping_status']
const PC_HOVER_FIELD_OPTIONS: Array<{ id: PcHoverCardField; label: string }> = [
...
const PC_HOVER_FIELD_IDS = new Set<PcHoverCardField>(PC_HOVER_FIELD_OPTIONS.map((field) => field.id))
 ...
 */
function linkedPcDisplay(marker: FloorIconMarker, pc: Computer | null) {
...
function normalizedPcHoverFields(layout: FloorLayout): PcHoverCardField[] {
...
function pcHoverFieldOptionsInOrder(fields: PcHoverCardField[]) {
...
const EQUIPMENT_KINDS: FloorIconKind[] = [
  'pc',
  'ethernet_outlet',
  'phone_outlet',
  'server',
...
const KIND_LABEL_KEY: Record<FloorIconKind, MessageKey> = {
  pc: 'sitemap.kinds.pc',
...
function markerTitle(marker: FloorIconMarker | null, kindFallback = ''): string {
