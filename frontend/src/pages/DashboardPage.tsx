  ...
  return (
    <div>
      ...
      <div className="dashboard-enter space-y-4" aria-busy={loading || undefined}>
        ...
        {/* Calendar mounts immediately so GET /dashboard/calendar overlaps summary. */}
        <div
          ...
          <div className="space-y-4">
            ...
            widgets['dist.office'] ? (
              <div className="dashboard-stagger grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {widgets['dist.by_os'] ? (
                  <SectionCard
                    title={t('dashboard.sections.byOs.title')}
                    dense
                ...
                {widgets['dist.by_manufacturer'] ? (
                  <SectionCard
                    title={t('dashboard.sections.byManufacturer.title')}
                    dense
                    className="flex flex-col"
                    bodyClassName="flex flex-1 items-center justify-center"
                  >
                ...
                {widgets['dist.ram_buckets'] ? (
                  <SectionCard
                    title={t('dashboard.sections.ram.title')}
                    dense
                    className="flex flex-col"
                    bodyClassName="flex flex-1 items-center justify-center"
                  >
                ...
                {widgets['dist.top_monitors'] ? (
                  <SectionCard
                    title={t('dashboard.sections.monitors.title')}
                    dense
                    className="flex flex-col"
                    bodyClassName="flex flex-1 items-center justify-center"
                  >
                ...
                {widgets['dist.top_cpu'] ? (
                  <SectionCard
                    title={t('dashboard.sections.cpu.title')}
                    dense
                    className="flex flex-col"
                    bodyClassName="flex flex-1 items-center justify-center"
                  >
                ...
                {widgets['dist.browsers'] ? (
                  <SectionCard
                    title={t('dashboard.sections.browsers.title')}
                    dense
                    className="flex flex-col"
                    bodyClassName="flex flex-1 items-center justify-center"
                  >
                ...
                {widgets['dist.office'] ? (
                  <SectionCard
                    title={t('dashboard.sections.office.title')}
                    dense
                    className="flex flex-col"
                    bodyClassName="flex flex-1 items-center justify-center"
                  >
                ...
                {widgets['list.peripheral_kinds'] ? (
                  ...
                  >
                    {!data.peripheral_kinds.length ? (
                      <p className="app-empty-state">{t('dashboard.sections.peripheralKinds.empty')}</p>
                    ) : (
                          ...
                          return (
                            ...
                            >
                              <div className="mb-1.5 flex justify-between gap-2">
                                <span
                                  className={`font-medium ${isSelected ? 'text-white' : 'text-[var(--color-fg-muted)]'}`}
                                >
                                  {p.label}
                                </span>
                                <span
        ...
        {data ? <DashboardDrilldownPanel selection={drilldown} onClose={() => setDrilldown(null)} /> : null}
      </div>
    </div>
  )
}
